...
class ViewportController {
    ...
    fitCenter(animation) {
        return __awaiter(this, void 0, void 0, function* () {
            const canvasBounds = this.context.canvas.getBounds();
            yield this.focus(canvasBounds, animation);
        });
    }
    focusElements(ids, animation) {
        return __awaiter(this, void 0, void 0, function* () {
            const { element } = this.context;
            if (!element)
                return;
            const elementsBounds = (0, bbox_1.getCombinedBBox)(ids.map((id) => element.getElement(id).getRenderBounds()));
            yield this.focus(elementsBounds, animation);
        });
    }
    focus(bbox, animation) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.transform({ mode: 'relative', translate: (0, vector_1.add)(delta, this.paddingOffset) }, animation);
        });
    }
    /**
     * <zh/> 获取画布元素在视口中的包围盒
