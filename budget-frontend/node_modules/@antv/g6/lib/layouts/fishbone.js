...
class FishboneLayout extends base_layout_1.BaseLayout {
    ...
    getRoot() {
        ...
        if ((0, util_1.isEmpty)(roots) || roots.length > 2)
            return;
        return roots[0];
    }
    formatSize(nodeSize) {
    ...
    doLayout(root, options) {
        ...
        const calculateY = (0, util_1.memoize)((node) => {
            ...
            if (!isAtEvenDepth(node)) {
                ...
                if ((0, util_1.isEmpty)(node.children))
                ...
                if ((0, util_1.isEmpty)(lastChild.children))
                ...
                if ((0, util_1.isEmpty)(prevSibling.children))
        ...
        const layout = (node) => {
            ...
            result.edges.push({ id: (0, exports_1.idOf)(edge), controlPoints: [controlPoint], relatedNodeId: node.id });
