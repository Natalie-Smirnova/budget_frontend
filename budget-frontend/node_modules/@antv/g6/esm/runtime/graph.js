...
export class Graph extends EventEmitter {
    ...
    render() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield Promise.all([animation === null || animation === void 0 ? void 0 : animation.finished, this.context.layout.layout()]);
            yield this.autoFit();
            this.rendered = true;
    ...
    layout() {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.context.layout.layout();
        });
    }
    /**
     * <zh/> 停止布局
    ...
    collapseElement(id_1) {
        return __awaiter(this, arguments, void 0, function* (id, animation = true) {
            const { model, element } = this.context;
            ...
            if (elementType === 'node')
                yield element.collapseNode(id, animation);
            else if (elementType === 'combo')
                yield element.collapseCombo(id, animation);
            this.isCollapsingExpanding = false;
        });
    }
    /**
    ...
    expandElement(id_1) {
        return __awaiter(this, arguments, void 0, function* (id, animation = true) {
            ...
            if (elementType === 'node')
                yield element.expandNode(id, animation);
            else if (elementType === 'combo')
                yield element.expandCombo(id, animation);
            this.isCollapsingExpanding = false;
        });
    }
