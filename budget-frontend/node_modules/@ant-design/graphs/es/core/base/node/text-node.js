...
export const TextNode = (props) => {
    ...
    return (React.createElement(StyledWrapper, { "$type": type, "$color": color, "$borderWidth": borderWidth, "$isActive": isActive, "$isSelected": isSelected, className: `text-node ${className}`, style: { ...style, ...font } },
