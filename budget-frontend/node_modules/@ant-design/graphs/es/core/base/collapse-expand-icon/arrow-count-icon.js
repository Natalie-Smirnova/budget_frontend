...
export const ArrowCountIcon = (props) => {
    ...
    const count = (countType === 'descendant' ? graph.getDescendantsData(data.id) : graph.getChildrenData(data.id))
        .length;
    return (React.createElement(StyledWrapper, { "$color": color, "$isCollapsed": isCollapsed, "$placement": placement, className: className, style: style },
        React.createElement("div", { className: "indented-icon-bar" }),
        React.createElement("div", { className: "indented-icon-circle" }, isCollapsed ? (count) : (React.createElement("div", { className: "indented-icon-circle-arrow" },
            React.createElement("svg", { width: "16", height: "16", viewBox: "0 0 16 16", fill: "none" },
                React.createElement("path", { d: "M11,4 L5,8 L11,12", stroke: "white", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" })))))));
};
