...
const TextNode = (props) => {
    ...
    return (react_1.default.createElement(StyledWrapper, { "$type": type, "$color": color, "$borderWidth": borderWidth, "$isActive": isActive, "$isSelected": isSelected, className: `text-node ${className}`, style: { ...style, ...font } },
