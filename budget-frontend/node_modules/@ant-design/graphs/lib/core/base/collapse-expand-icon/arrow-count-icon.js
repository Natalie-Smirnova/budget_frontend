...
const ArrowCountIcon = (props) => {
    ...
    const count = (countType === 'descendant' ? graph.getDescendantsData(data.id) : graph.getChildrenData(data.id))
        .length;
    return (react_1.default.createElement(StyledWrapper, { "$color": color, "$isCollapsed": isCollapsed, "$placement": placement, className: className, style: style },
        react_1.default.createElement("div", { className: "indented-icon-bar" }),
        react_1.default.createElement("div", { className: "indented-icon-circle" }, isCollapsed ? (count) : (react_1.default.createElement("div", { className: "indented-icon-circle-arrow" },
            react_1.default.createElement("svg", { width: "16", height: "16", viewBox: "0 0 16 16", fill: "none" },
                react_1.default.createElement("path", { d: "M11,4 L5,8 L11,12", stroke: "white", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" })))))));
};
