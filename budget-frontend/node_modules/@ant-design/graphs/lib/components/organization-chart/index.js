...
exports.OrganizationChart = (0, react_1.forwardRef)(({ children, ...props }, ref) => {
    const options = (0, react_1.useMemo)(() => {
        ...
        const options = (0, options_1.mergeOptions)(constants_1.COMMON_OPTIONS, options_2.DEFAULT_OPTIONS, (0, options_2.getOrganizationChartOptions)({ direction }), restProps);
        return options;
    }, [props]);
